...
class Shader : QObject
{
    ...
    public:       
        ...
        void setMatrix(const char* label, const glm::mat4 &mat, bool transpose = false);
        void setMatrix(const char* label, const glm::mat3 &mat, bool transpose = false);
    ...
    private:		
        ...
        unsigned int compile(const char *source, unsigned int type, const char* filename);
        void cleanUp();        
