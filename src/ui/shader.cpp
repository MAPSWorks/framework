...
void Shader::link() const
{
    ...
    if (!success) { 
        ...
        std::cout << "ERROR::SHADER::link() Link-time error: " << logstr << std::endl;
        delete[] logstr;
    } 
}
...
void Shader::attachVertexShader(const char *fileName)
{
    if(fileName)
    {
        ...
        {
            std::cout << "ERROR::SHADER::attachVertexShader(): not found: " << fileName << std::endl;
        }
    }
}
...
void Shader::attachControlShader(const char *fileName)
{
    if(fileName)
    {
        ...
        {
            std::cout << "ERROR::SHADER::attachControlShader(): not found: " << fileName << std::endl;
        }
...
void Shader::attachEvaluationShader(const char *fileName)
{
    if(fileName)
    {
        ...
        {
            std::cout << "ERROR::SHADER::attachEvaluationShader(): not found:"  << fileName << std::endl;
        }
...
void Shader::attachGeometryShader(const char *fileName)
{
    if(fileName)
    {
        ...
        {
            std::cout << "ERROR::SHADER::attachGeometryShader(): not found: " << fileName << std::endl;
        }
    }
}
...
void Shader::attachFragmentShader(const char *fileName)
{
    if(fileName)
    {
        ...
        {
            std::cout << "ERROR::SHADER::attachFragmentShader(): not found: " << fileName << std::endl;
        }
    }
}
...
{
    glUniform3fv(glGetUniformLocation(m_id, label), 1, glm::value_ptr(glm::vec3(arg1, arg2, arg3)));
}
...
void Shader::setMatrix(const char* label, const glm::mat4 &mat, bool transpose)
{
    glUniformMatrix4fv(glGetUniformLocation(m_id, label), 1, transpose, glm::value_ptr(mat));
}

void Shader::setMatrix(const char* label, const glm::mat3 &mat, bool transpose)
{
    glUniformMatrix3fv(glGetUniformLocation(m_id, label), 1, transpose, glm::value_ptr(mat));
}
