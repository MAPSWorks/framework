...
public:
    ...
    // Texture Attachment
    void createTexAttachment(GLenum attachment, GLuint iFormat, GLuint format,
                             GLuint type, bool noColorbuffer,
    ...
    // Renderbuffer Object Attachment
    void createRenderBufferAttachment(GLenum attachment, GLenum bufferFormat);
